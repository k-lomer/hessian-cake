...
model_data_loss = [{"model":"dnn", "data": "mnist", "loss": "cross_entropy", "hidden_layers": [100,10], "epochs": 3},
                   {"model":"autoencoder", "data": "mnist", "loss": "least_squares", "epochs": 1},
...
optimizer = [{"optimizer": "newton", "lr": 0.1, "batch_size": 1000}, {"optimizer": "adam", "lr": 1e-3, "batch_size": 128}, {"optimizer": "sgd", "lr": 1e-2, "batch_size": 128}]
...
# pass an empty dict for default inexact_newton_params
...
if __name__ == '__main__':
    ...
    # Enable eager execution in tf v1
